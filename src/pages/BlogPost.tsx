...
// Import the blog post data (we'll use the same data as in the Blog.tsx file)
const blogPosts = [
  {
    id: 1,
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                {relatedPosts.map((relatedPost) => (
                  <Link to={`/blog/${relatedPost.slug}`} key={relatedPost.id} className="hover:no-underline">
                    <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow h-full flex flex-col">
                      ...
                      <div className="p-4 text-sm text-gray-500 flex justify-between border-t">
